<template>
  <div class="seller">
    ...
    <div class="seller-deils seller-info-style">
      ...
      <div class="seller-deils-item" v-for="(item,index) in seller.supports" :key="index">
    ...
    <div class="live-action seller-info-style">
      <h2>商家实景</h2>
      <div class="live-imgs">
        <div class="live-action-item" v-for="(item,index) in seller.pics" :key="index"> 
          <img :src="item" />
        </div>
      </div>
    </div>
    ...
    <div class="seller-info seller-info-style">
      <h2>商家信息</h2>
      <div class="info-item" v-for="(item,index) in seller.infos" v-text="item" :key="index"></div>
    </div>
