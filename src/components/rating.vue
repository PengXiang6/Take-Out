<template>
  <div class="ratings" id='ratings'>
    ...
    <div class="comment-list">
      <div class="comment-item" v-for="(item,index) in retings" :key="index">
        ...
        <div class="recommend" v-if='item.recommend.length>0'>
          ...
          <span class="recommend-tab" v-for="(recommend,idx) in item.recommend" v-text="recommend" :key="idx"></span>
        </div>
      </div>
    </div>
  </div>
